...
| In-text source identifiers and references | PASS: the Part 2 index, requirements tables, RTM, acceptance criteria, decision record, AI register and defence notes use `SRC-MASTER`/`SRC-M1` citations where they make course-brief claims; reference lists identify both source documents. |
