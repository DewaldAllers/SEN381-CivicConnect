...
| --- | --- |
| Team | Dewald Allers, Liam de Villiers, Tristan Els, from SRC-A1 |
| Part 2 | Dewald: requirements, acceptance criteria, RTM, AI register |
| Other ownership | Team to agree named owners and handovers |
| Availability, communication and response times | Team to agree; no invented schedule |
| Reviews | Both other registered team members review substantive changes; real approvals on current PR content |
| Conflict handling | Record competing views/evidence; team to agree escalation route |
...
| --- | --- | --- | --- |
| Dewald Allers | Pending | Pending | Pending |
| Liam de Villiers | Pending | Pending | Pending |
| Tristan Els | Pending | Pending | Pending |
