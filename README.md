...
Milestone 1 | Dewald Allers | Status: review draft, not an approved baseline.

This branch contains only Dewald's Part 2 contribution and its supporting material. Other members' sections and project-wide templates are outside this branch's scope.
...
- [Presentation notes](docs/requirements/part-2-defence-notes.md) - short script and practice questions.
